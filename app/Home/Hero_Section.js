...
const Hero_Section = () => {
  ...
  return (
    <div className="relative h-[100vh] md:h-dvh w-full overflow-hidden">
      <div className="relative w-auto h-dvh">
        <div className="relative w-auto h-dvh flex justify-center">
